...
if [[ ! -f ~/.osx-bootstrap/.osx-bootstrap ]]; then
    ...
    # Enabling subpixel font rendering on non-Apple LCDs 0-4 where 0 is none.
    # To disable this option. defaults delete NSGlobalDomain AppleFontSmoothing
